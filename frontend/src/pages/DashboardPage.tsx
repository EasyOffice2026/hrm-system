...
export default function DashboardPage() {
  ...
  const cards = data ? [
    ...
    { label: `${t("payroll")} (${data.month})`, value: kd(data.payroll_total), icon: Wallet, color: "bg-blue-500", to: "/hr" },
    { label: t("payroll_pending"), value: kd(data.payroll_pending), icon: Banknote, color: "bg-indigo-500", to: "/hr" },
