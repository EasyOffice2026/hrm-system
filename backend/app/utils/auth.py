...
SECRET_KEY = os.environ.get("JWT_SECRET", "hrm-secret-key-change-in-production")
ALGORITHM = "HS256"
...
MODULE_RESTRICTED_ROLES = ("personnel", "personnel_manager")


def get_business_user(user: User = Depends(get_current_user)) -> User:
    """Company-wide dashboards are not available to module-restricted roles."""
